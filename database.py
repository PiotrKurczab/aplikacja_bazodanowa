...
class Database(QObject):
   # Signal emitted when a record is updated
   ...
   # Method to populate the tables with initial data
   ...
   # Method to fetch customer orders with customer and product details
   ...
   # Method to insert a new record into a table
